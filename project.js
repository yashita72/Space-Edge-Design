...
const projects = [
  ...
  },
  {
    ...
    location:    'Ganga Yamuna Hindon Society, Siddharth Vihar',
    description: 'A premium 3 BHK full-home interior designed with modern aesthetics, functional layouts, elegant storage solutions, and high-quality finishes to create a comfortable and sophisticated living space.',
    services:    ['Full Home Interior', 'Modular Kitchen', 'Wardrobes', 'False Ceiling'],
    area:        '1600 sq.ft.',
    year:        '2024',
  ...
  {
    number:      '05',
    title:       'Independent House Modular Kitchen',
    location:    'Vaishali',
    description: 'A custom-designed modular kitchen featuring efficient space planning, premium cabinetry, durable finishes, and modern accessories tailored for an independent house.',
    services:    ['Modular Kitchen', 'Storage Solutions', 'Premium Finishes', 'Custom Design'],
    area:        '150 sq.ft.',
    year:        '2023',
  ...
  {
    number:      '06',
    title:       'Luxury 3 BHK Interior',
    location:    'Royce Sentosa, Raj Nagar Extension',
    description: 'A modern 3 BHK interior project with elegant living spaces, customized furniture, modular kitchen, premium wardrobes, and contemporary lighting to deliver a refined lifestyle.',
    services:    ['Full Home Interior', 'Modular Kitchen', 'Wardrobes', 'Living Room'],
    area:        '1500 sq.ft.',
    year:        '2024',
  ...
  },
  {
    ...
    location:    'Jaipuria Sunrise Green, Indirapuram',
    description: 'A complete 3 BHK interior project featuring premium materials, elegant false ceilings, custom wardrobes, modular kitchen, and thoughtfully designed living spaces.',
    services:    ['Full Home Interior', 'Modular Kitchen', 'False Ceiling', 'Wardrobes'],
    area:        '1800 sq.ft.',
    year:        '2024',
  ...
  },
  {
    ...
    location:    'Royce Sentosa, Raj Nagar Extension',
    description: 'A luxurious 3 BHK interior crafted with modern design elements, customized storage, premium finishes, and contemporary aesthetics to create a timeless living experience.',
    services:    ['Full Home Interior', 'Modular Kitchen', 'Wardrobes', 'TV Unit'],
    area:        '1500 sq.ft.',
    year:        '2025',
